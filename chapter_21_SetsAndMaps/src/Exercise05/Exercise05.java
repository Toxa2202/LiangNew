...
/**
 * Created by anton.sviatov on 09.08.2019.
 */
public class Exercise05 {
    public static void main(String[] args) throws IOException {
        ...
        highlighter(inputFile, outputFile);
    }

    public static void highlighter(File inputFile, File outputFile) throws IOException {
        ...
        while (pos < javaFile.length()) {
            ...
            if (work == 0) {
                if (ch == '\"') {
                    ...
                    if ((!Character.isAlphabetic(javaFile.charAt(pos - 1))) &&
                            (!Character.isDigit(javaFile.charAt(pos - 1))) &&
                            (javaFile.charAt(pos - 1) != '_')) {
                        String tmp = "<span class = \"literal\">";
                        javaFile.insert(pos, tmp);
                        pos += tmp.length();
                        work = 3;
        ...
        htmlText.append("<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=windows-1251\">");
        ...
        outputStream.writeBytes(htmlText.toString());
        outputStream.close();
    }
...
// Дивна помилка. Випадково заімпортив якийсь стрінг з xml бібліотекиб
// і в мене перестав оприділятись стрінг. Мусив вручну писати шлях...